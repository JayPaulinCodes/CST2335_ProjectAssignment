...
/**
 * List Adapter class for the list of events on the search page.
 *
 * @author Jacob Paulin
 */
public class EventListAdapter extends BaseAdapter {
    ...
    /**
     * Constructor for the EventListAdapter class
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        @SuppressLint("ViewHolder") View view = jActivity.getLayoutInflater().inflate(R.layout.layout_event_list_item, parent, false);
